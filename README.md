...
It's:
- 🚀 **Fast:** Under the right (and typical) circumstances, it can send a list of ~300 players in under *3 seconds,* most of which (2+ seconds) is spent waiting out Discord's ratelimits.
